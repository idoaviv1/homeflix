...
1. **Apply the change across ALL platforms**:
   ...
   - **Galaxy S22 Ultra App (Android APK)**: Always run `npx cap sync android`, ensure Android compatibility (cleartext HTTP, network security, hardware acceleration), and rebuild/save APKs to `/media/windows/Shared-APK/`.
...
2. **Never leave any platform behind**:
   ...
   - Maintain the dual output folders:
     ...
     - `/media/windows/Shared-APK/` for Samsung Galaxy S22 Ultra Android packages.
